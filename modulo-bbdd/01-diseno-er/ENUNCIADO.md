...
## Preparar la base en el visor (opcional)

Este ejercicio es **teórico** (diagrama y tablas en un documento). Si quieres tener ya creada la base `academia_idiomas` para los ejercicios SQL siguientes, en JAVe-Ando usa **Ejecutar solución** (ejecuta `sql/01_crear_base_datos.sql`). Configura antes la conexión en **Herramientas → Configurar conexión SQL…**.
